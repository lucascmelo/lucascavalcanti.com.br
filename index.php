...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Lucas Cavalcanti - Web Designer</title>
        ...
        <link rel="stylesheet" href="css/lucascavalcanti.css">
    ...
    <body>
        ...
        <script>(function(d, s, id) {
          ...
          js.src = "//connect.facebook.net/pt_BR/all.js#xfbml=1&appId=275235885823989";
          fjs.parentNode.insertBefore(js, fjs);
        }(document, 'script', 'facebook-jssdk'));
        </script>
        <div>
            <section id="content" class="fl">
                <div class="header-container">
                    <header class="clearfix">
                        <div class="logotipo"><img src="img/lucascavalcanti-logotipo.png" alt=""></div>
                        <h1 class="title lucas">Lucas Cavalcanti</h1>
                        <div class="fr">
                        ...
                        <div class="main wrapper clearfix">
                            <fieldset>
                                ...
                                <form action="">
                                    ...
                                    <textarea name="msg" placeholder="EM QUE POSSO AJUDAR?"></textarea>
                                    <hr>
                            ...
                            <aside>
                                <p>
                                    CONTATOS<br>
                                    +55 84 8768-9004<br>
                                    <a href="mailto:contato@lucascavalcanti.com.br?subject=Contato:%20Lucas%20Cavalcanti%20-%20Web%20Designer">contato@lucascavalcanti.com.br</a>
                                </p>
                            </aside>
                        </div>
                    </article>
